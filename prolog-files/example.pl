%domyslnie nie bylo nawiasow, online-parser sie wysypywal
...
wykonaj :- zwierze_jest(X), !, format('~nTwoim zwierzeciem moze byc ~w', X), nl, wyczysc_fakty.
            
wykonaj :- write('Nie jestem w stanie odgadnac co to za zwierze.'), nl, wyczysc_fakty.
